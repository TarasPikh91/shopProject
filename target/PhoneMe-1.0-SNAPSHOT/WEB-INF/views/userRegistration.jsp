...
<%--<u:forEach var="userRegistration" items="${users}">--%>
	<%--${userRegistration.firstName} ${userRegistration.userLogin}--%>
		<%--<a href="/deleteUserRegistration/${userRegistration.id}">delete</a>--%>
		<%--<a href="/updateUserRegistration/${userRegistration.id}">update</a>--%>
<%--</u:forEach>--%>
